          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <button @click="fetchKetelaList()" class="input-group-addon"><i class="fa fa-search"></i></button>
              </div>
            </div>
          </div>
          ...
          <table class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
              <tr v-for="(task, index) in list.data" :key="index">
                ...
                <td>
                  <button type="button" class="btn btn-primary" @click="popUpEditKetela(task.RecID)"><i class="fa fa-edit"></i></button>
                  <button @click="popUpDeleteKetela(task)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>
                </td>
              </tr>
            </tbody>
          </table>
